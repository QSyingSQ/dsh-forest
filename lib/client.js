window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const LIGHT_ID = "typora-forest-light";
		const DARK_ID = "typora-forest-dark";
		const MODE_KEY = "dsh.typora-forest.mode";
		const FONT_KEY = "dsh.typora-forest.font";
		const LOCALE_NS = "settings.typora-forest";
		const OVERRIDE_SOURCE = "dsh-skin-typora-forest";
		...
		const SHIKI_L = {
			...
			"shiki-token-parameter": "#ffcb6b", "shiki-token-function": "#82b1ff", "shiki-token-string-expression": "#c3e88d",
		...
		function apply(ctx) {
			...
			ctx.effect(() => {
				...
				tag.dataset.plugin = "dsh-skin-typora-forest";
				tag.dataset.pluginCss = "dsh-skin-typora-forest/fonts.css";
