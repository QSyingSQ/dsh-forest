window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const SKIN_CSS = [
			...
			'.md-code-block > div:first-child > div > div:first-child, .md-code-block > div:first-child > div > div:nth-child(2) button { color: #eef5f1; }',
			'body[data-ds-dark-theme] .md-code-block > div:first-child > div > div:first-child, body[data-ds-dark-theme] .md-code-block > div:first-child > div > div:nth-child(2) button { color: #dcefe6; }'
		].join("\\n");
